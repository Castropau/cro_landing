...
export default function Navbar() {
  ...
  return (
    ...
    <nav className="fixed top-0 w-full z-50 bg-[#003e90] dark:bg-[#0e0e0f] text-black px-6 py-4 flex justify-between items-center border-white/10 dark:text-white">
      {/* Left: Logo */}
      {/* <div className="text-2xl font-bold hover:text-cyan-400 transition-colors uppercase">
        <Link
          href="/"
          className="text-center font-bold text-2xl system-name mb-3 text-[#2e6ab8]"
        >
          SMARTARK SYS
        </Link>
      </div> */}
      <div className="text-2xl font-bold hover:text-cyan-400 transition-colors uppercase">
        <Link
          href="/"
          className="flex items-center gap-2 text-center font-bold text-2xl system-name mb-3 text-[#2e6ab8]"
        >
          <Image
            src="/images/tslogo.png" // 🔁 Replace with your actual logo path
            alt="Smartark Logo"
            width={32}
            height={32}
            priority
      ...
      <div className="hidden md:flex items-center gap-6 ">
        <Link
          href="/"
          className="hover:text-cyan-400 text-[#a2b5ce] transition-colors"
        >
          {t("home")}
        </Link>
        {/* <Link
        ...
        <div className="relative" ref={dropdownRef}>
          <span className="text-sm flex justify-center text-[#a2b5ce]">
            Language
          </span>
          <button
